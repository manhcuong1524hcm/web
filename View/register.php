      ...
      <div class="col-md-6">
        <div class="form-group">
          <div class="bo4 input-group mb-2 mr-sm-2 mb-sm-0">
            ...
            <input type="text" name="email" class="form-control" id="email" placeholder="you@gmail.com" required autofocus>
          </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <div class="bo4 input-group mb-2 mr-sm-2 mb-sm-0">
            ...
            <input type="password" name="password_1" class="form-control" id="password-confirm" placeholder="Password" required>
          </div>
...
include './View/layouts/scripts.php';
?>