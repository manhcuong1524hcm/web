...
<head>
  ...
  <link href="../../vendors/fonts/circular-std/style.css" rel="stylesheet">
  <link rel="stylesheet" href="../../vendors/css/style.css">
  <link rel="stylesheet" href="../../vendors/fonts/fontawesome/css/fontawesome-all.css">
  <style>
    html,
    body {
      height: 100%;
...
<body>
  ...
  <div class="splash-container">
    <div class="card">
      <div class="card-header text-center"><img class="logo-img" src="../../img/logo.png" alt="logo"><span class="splash-description">Please enter your user information.</span></div>
      <div class="card-body">
        <form>
