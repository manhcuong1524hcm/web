          ...
          <div class="grid_item wd55">
            <div class="courses_item">
              ...
              <div class="hover_text">
                ...
                <a href="#">
                  <h4>Japanese Language Class</h4>
                </a>
                <ul class="list">
                  <li><a href="#"><i class="lnr lnr-users"></i> 410</a></li>
                  <li><a href="#"><i class="lnr lnr-bubble"></i> 55</a></li>
          ...
          <div class="grid_item wd55">
            <div class="courses_item">
              ...
              <div class="hover_text">
                ...
                <ul class="list">
                  <li><a href="#"><i class="lnr lnr-users"></i> 400</a></li>
      ...
      <div class="col-lg-3">
        <div class="course_item">
          ...
          <div class="hover_text">
            ...
            <ul class="list">
              <li><a href="#"><i class="lnr lnr-users"></i> 300</a></li>
              <li><a href="#"><i class="lnr lnr-bubble"></i> 30</a></li>
              <li><a href="#"><i class="lnr lnr-user"></i> T. Robert</a></li>
            </ul>
          </div>
...
<section class="team_area p_120">
  <div class="container">
    ...
    <div class="row team_inner" style="margin-left: 250px">
      <div class="col-lg-3 col-sm-6">
        <div class="team_item">
          <div class="team_img">
            <img class="rounded-circle" src="Assets/img/team/team-1.jpg" alt="">
            <div class="hover">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="team_item">
          <div class="team_img">
            <img class="rounded-circle" src="Assets/img/team/team-2.jpg" alt="">
            <div class="hover">
              <a href="#"><i class="fa fa-facebook"></i></a>
              <a href="#"><i class="fa fa-twitter"></i></a>
              <a href="#"><i class="fa fa-linkedin"></i></a>
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="team_item">
          <div class="team_img">
            <img class="rounded-circle" src="Assets/img/team/team-3.jpg" alt="">
            <div class="hover">
              <a href="#"><i class="fa fa-facebook"></i></a>
              <a href="#"><i class="fa fa-twitter"></i></a>
              <a href="#"><i class="fa fa-linkedin"></i></a>
